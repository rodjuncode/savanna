...
import br.com.rodrigojunqueira.savanna.core.Savanna;


public class RunTravellingSalesmanWithSavanna {
	...
	public static void main(String[] args) {
		...
		while(true)	 {
			savanna = new Savanna(15, travellingSalesmanFactory);
			long startTime = System.currentTimeMillis();
			while (!savanna.getKing().isGoodEnough() && savanna.getGeneration() < 100000) {
				savanna.nextGeneration();
			/*	System.out.println(savanna.getGeneration());
				System.out.print("Savanna - ");
				savanna.getKing().show();	
				System.out.print("Pride 0 - ");
				savanna.prides[0].getKing().show();	
				System.out.print("Nomad 0 - ");
				savanna.nomads[0].show();	
				System.out.print("Pride 1 - ");
				savanna.prides[1].getKing().show();	
				System.out.print("Nomad 1 - ");
				savanna.nomads[1].show();	
				System.out.print("Pride 2 - ");
				savanna.prides[2].getKing().show();
				System.out.print("Nomad 2 - ");
				savanna.nomads[2].show();	
				System.out.print("Pride 3 - ");
				savanna.prides[3].getKing().show();
				System.out.print("Nomad 3 - ");
				savanna.nomads[3].show();*/
	
			}
			if (savanna.getKing().isGoodEnough()) {
				goalCount++;
			}
			totalCount++;
			long endTime   = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			System.out.println(goalCount + "/" + totalCount + " - Finished on generation " + savanna.getGeneration() + " under " + totalTime/1000/60 + " minute(s).");
			savanna.getKing().show();
